      ...
      <div className="section-container">
            ...
            <div className="flex items-center mb-6">
              <div className="w-10 h-10 bg-white bg-opacity-10 rounded-lg flex items-center justify-center mr-3">
                <svg className="w-6 h-6 text-white" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M7 21H3L3 3L21 3V7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M17 21H21V10.4126C21 10.1489 20.9158 9.88949 20.7573 9.6734L17.3267 5.24277C17.1105 5.08421 16.8511 5 16.5874 5H7V16.7232C7 16.9865 7.10344 17.2358 7.28816 17.4205L7.6 17.7324" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M17 21C17 18.7909 14.5 17 12.5 17C10.5 17 9 18 7 17C7 19.2091 9.5 21 11.5 21C13.5 21 15 21 17 21Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
              <span className="text-xl font-rooftop">firmi</span>
            </div>
            <p className="text-gray-300 mb-6">
              Document processing reimagined with AI.
              Transform your workflow with unmatched accuracy and efficiency.
            </p>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-400 mb-4 md:mb-0">
            &copy; 2025 Firmi, Inc. All rights reserved.
          </div>
